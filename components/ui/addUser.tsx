      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-1">
          <div className="space-y-2">
            <Label htmlFor="itemVariation">User name</Label>
            <Input id="itemVariation" placeholder="Enter equipment name" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="itemVariation">Password</Label>
            <Input id="itemVariation" placeholder="Enter equipment name" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="statusDetails">Select Team</Label>
            <Select>
              <SelectTrigger>
